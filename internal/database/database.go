...
func AutoMigrate(db *gorm.DB) error {
	...
	if err := db.AutoMigrate(&Site{}, &Certificate{}, &SemanticFingerprint{}, &AccessLog{}, &AttackLog{}, &AccessRule{}, &CCPolicy{}, &ProtectionRule{}, &SiteProtectionPolicy{}, &PolicyVersion{}, &PolicyAudit{}, &AuditEvent{}); err != nil {
		return err
	}
