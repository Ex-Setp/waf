...
func AutoMigrate(db *gorm.DB) error {
	...
	return db.AutoMigrate(&Site{}, &Certificate{}, &SemanticFingerprint{}, &AccessLog{}, &AttackLog{}, &AccessRule{}, &CCPolicy{}, &ProtectionRule{}, &SiteProtectionPolicy{}, &PolicyVersion{}, &PolicyAudit{}, &AuditEvent{})
}
